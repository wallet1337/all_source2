...
#include <base/cfg.h>
#include <gui/deps/renderer/include/ren/types.h>
...
namespace hacks
{
	...
	public:
		...
		void equip(int32_t weapon, int32_t team, int32_t paint_kit, float wear, int32_t seed, int32_t stattrak, bool dyn_stattrak);
	...
	private:
		...
		std::array<evo::ren::color, 8> rarity_colors = {
				evo::ren::color(190,195,205),
				evo::ren::color(100,150,225),
				evo::ren::color(75,105,205),
				evo::ren::color(135,70,255),
				evo::ren::color(210,45,230),
				evo::ren::color(235,75,75),
				evo::ren::color(200,170,5),
				evo::ren::color(135,105,10),
		};
	};
