...
namespace hacks
{
	...
	public:
		...
		bool did_stop() const;
		bool did_stop_last_interval() const;
	...
	private:
		...
		std::optional<detail::aim_helper::rage_target> scan_targets(sdk::user_cmd* cmd);
		...
		std::optional<detail::aim_helper::rage_target> scan_record(detail::lag_record& record, const bool minimal = false, bool extrapolate = false);
		std::optional<detail::aim_helper::rage_target> scan_record_knife(const std::shared_ptr<detail::lag_record>& record);
		std::optional<detail::aim_helper::rage_target> scan_record_shield(const std::shared_ptr<detail::lag_record>& record);
		std::optional<detail::aim_helper::rage_target> scan_record_gun(const std::shared_ptr<detail::lag_record>& record, const bool minimal = false);
		...
		bool has_stopped{}, should_stop{}, stopped_last_interval{}, should_duck{}, is_engaged{},
			recalculate_eye_position{},	had_target{}, is_priority_scan{}, active{},
			attempted_to_jump{};
