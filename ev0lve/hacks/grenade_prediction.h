...
namespace hacks
{
	...
	public:
		...
		std::optional<sdk::vec3> to_end(sdk::weapon_t* wpn, sdk::cs_player_t* thrower, bool molotov = false, float* progress = nullptr);
	...
	private:
		...
		void move_entity(sdk::trace_simple_filter& filter, sdk::vec3& vec_src, const sdk::vec3& move, sdk::game_trace& tr, uint32_t mask = mask_solid | contents_current_90);
		void hull_trace(sdk::trace_simple_filter& filter, const sdk::vec3& vec_src, const sdk::vec3& vec_dest, sdk::game_trace& tr, uint32_t mask = mask_solid | contents_current_90);
