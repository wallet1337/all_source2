...
namespace lua::helpers
{
	...
	{
		size_t offset;
		sdk::send_prop_type type;
		sdk::send_prop_type child_type;
	};
	...
	var get_netvar(const char* name, sdk::recv_table* table, size_t offset = 0);
	...
	uintptr_t find_pattern(const uint8_t* module, const char* pattern, const ptrdiff_t off = 0);
