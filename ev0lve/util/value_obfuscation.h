...
#define XOR_16(val) (decltype(val))(::util::xor_value<uint16_t, (uint16_t) val, ::util::random::_uint<__COUNTER__, 0xFFFF>::value>::get())
#define XOR_32(val) (decltype(val))(::util::xor_value<uint32_t, (uint32_t) val, ::util::random::_uint<__COUNTER__, 0xFFFFFFFF>::value>::get())
