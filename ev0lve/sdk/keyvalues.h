...
namespace sdk
{
	...
	{
	public:
		VIRTUAL(4, get_symbol_for_string(const char* name, bool create), int(__thiscall*)(void*, const char*, bool))(name, create);
	...
	{
	private:
		FUNC(game->client.at(functions::keyvalues::init), init(const char* name), void(__thiscall*)(void*, const char*, int, int))(name, 0, 0)
		FUNC(game->client.at(functions::keyvalues::load_from_buffer), load_from_buffer(char const* name, const char* buffer),
			bool(__thiscall*)(void*, const char*, const char*, void*, void*, void*, void*))(name, buffer, nullptr, nullptr, nullptr, nullptr)
		FUNC(game->client.at(functions::keyvalues::set_string_int), set_string_int(const char* value), void(__thiscall*)(void*, const char*))(value)
	...
	public:
		...
		{
			const auto kv = reinterpret_cast<keyvalues* const>(game->mem_alloc->alloc(36));
			kv->init(type);
		...
		{
			return game->key_values_system->get_symbol_for_string((uint16_t(key_name_case_sensitive2) << 8) | uint8_t(key_name_case_sensitive1));
		}
