...
namespace sdk
{
	...
	public:
		...
		quaternion_aligned(const quaternion& o) { x = o.x; y = o.y; z = o.z; w = o.w; }
	...
	public:
		...
		inline radian_euler(float X, float Y, float Z) { x = X; y = Y; z = Z; }
	...
	struct studiohdr {
		...
		int numikchains;
		int ikchainindex;
		inline mstudioikchain_t* ik_chain(int i) const { return (mstudioikchain_t *)(((uintptr_t)this) + ikchainindex) + i; };
		int nummouths;
		int mouthindex;
	...
	public:
		void* cache;
		const studiohdr* get_studio_hdr(void) const
		{
			return (studiohdr*)cache;
		}
	...
	struct mstudiolinearbone_t
	{
		...
		int    qalignmentindex;
		inline const quaternion& qalignment(int i) const { return *((quaternion*)(((uint8_t*)this) + qalignmentindex) + i); };
	...
	struct studiohdr2_t
	{
		...
		int linearboneindex;
		inline mstudiolinearbone_t* pLinearBones() const { return (linearboneindex) ? (mstudiolinearbone_t*)(((uint8_t*)this) + linearboneindex) : NULL; }
	...
	{
		FUNC(game->client.at(functions::hdr::find_hash), find_hash(hash_value_type* value), uint32_t(__thiscall*)(void*, hash_value_type*))(value)
	...
	{
		FUNC(game->client.at(functions::hdr::reinitialize), reinitialize(cstudiohdr* hdr), void(__thiscall*)(void*, cstudiohdr*))(hdr)
	...
	public:
		...
		inline mstudiolinearbone_t* pLinearBones() const { return hdr->studiohdr2index ? hdr->pStudioHdr2()->pLinearBones() : NULL; }
		inline virtualmodel_t* GetVirtualModel(void) const { return v_model; };
		...
		mstudioseqdesc_t* get_seq_desc(const int index)
		{
			...
			return ((mstudioseqdesc_t*(__thiscall*)(void*, int32_t))(game->server.at(functions::hdr::lookup)))(this, index);
		}
	...
	public:
		...
		VIRTUAL(32, get_studio_model(const model* mod), studiohdr*(__thiscall*)(void*, const model*))(mod)
