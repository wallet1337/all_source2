...
namespace sdk
{
	...
	public:
		...
		entity_t* get_skip_entity()
		{
			return ent;
		}

		void set_skip_entity(entity_t* const other)
		{
			ent = other;
		}
	...
	public:
		...
		bool should_hit_entity(entity_t* ent, int) override
		{
			return !ent || !ent->is_player() || (ent->index() != player->index() && !reinterpret_cast<cs_player_t*>(ent)->is_enemy(player));
		}
	...
	{
	public:
		trace_no_grenades_filter(entity_t* ent)
		{
			this->ent = ent;
		}
	...
	public:
		...
		{
			return entity == game->client_entity_list->get_client_entity(0);
		}
	...
	{
	public:
		VIRTUAL(1, get_point_contents_world_only(vec3& abs_position, int mask), int(__thiscall*)(void*, vec3&, int))(abs_position, mask)
		VIRTUAL(3, clip_ray_to_entity(ray& r, const uint32_t mask, entity_t* ent, game_trace* trace), void(__thiscall*)(void*, ray&, uint32_t, entity_t*, game_trace*))(r, mask, ent, trace)
		VIRTUAL(5, trace_ray(ray& r, const uint32_t mask, trace_filter* filter, game_trace* trace), void(__thiscall*)(void*, ray&, uint32_t, trace_filter*, game_trace*))(r, mask, filter, trace)
	};
}
