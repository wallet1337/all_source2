...
namespace sdk
{
	...
	public:
		...
		{
			return *reinterpret_cast<cutlvector<ref_counted*>*>(uint32_t(this) + 0x14);
		}

		cutlvector<ref_counted*>& get_visual_data_processors()
		{
			return *reinterpret_cast<cutlvector<ref_counted*>*>(uint32_t(this) + 0x230);
		}

		FUNC(game->client.at(offsets::weapon_csbase::fn_get_econ_static_data), get_static_data(), econ_item_definition*(__thiscall*)(void*))()
	};

	class weapon_t : public entity_t
	{
	public:
		FUNC(game->client.at(offsets::weapon_csbase::fn_get_econ_item_view), get_econ_item_view(), econ_item_view*(__thiscall*)(void*))()
		FUNC(game->client.at(offsets::weapon_csbase::fn_equip_glove), equip_glove(cs_player_t* player), void(__thiscall*)(void*, cs_player_t*))(player)
		...
		inline bool is_grenade() { return get_item_definition_index() >= item_definition_index::weapon_flashbang && get_item_definition_index() <= item_definition_index::weapon_incgrenade; }
		...
		inline std::wstring get_localized_name()
		{
			return game->localize->find_safe(get_cs_weapon_data()->szhudname);
		}
		...
		{
			return get_item_definition_index() == item_definition_index::weapon_g3sg1 || get_item_definition_index() == item_definition_index::weapon_scar20
				|| get_item_definition_index() == item_definition_index::weapon_ssg08 || get_item_definition_index() == item_definition_index::weapon_awp
				|| get_item_definition_index() == item_definition_index::weapon_sg556 || get_item_definition_index() == item_definition_index::weapon_aug;
		}

		inline bool is_pistol()
		{
			return get_weapon_type() == weapontype_pistol;
		}

		inline bool is_heavy_pistol()
		{
			return get_item_definition_index() == item_definition_index::weapon_deagle || get_item_definition_index() == item_definition_index::weapon_revolver;
		}

		inline bool is_shotgun()
		{
			return get_weapon_type() == weapontype_shotgun;
		}
		...
		{
			return get_item_definition_index() != item_definition_index::weapon_taser && get_weapon_type() == weapontype_knife;
		}

		inline bool is_automatic()
		{
			const bool is_smg = get_item_definition_index() == item_definition_index::weapon_bizon ||
				get_item_definition_index() == item_definition_index::weapon_mac10 || get_item_definition_index() == item_definition_index::weapon_p90 ||
				get_item_definition_index() == item_definition_index::weapon_ump45 || get_item_definition_index() == item_definition_index::weapon_mp7 ||
				get_item_definition_index() == item_definition_index::weapon_mp9 || get_item_definition_index() == item_definition_index::weapon_mp5sd;

			const bool is_rifle = get_item_definition_index() == item_definition_index::weapon_ak47 ||
				get_item_definition_index() == item_definition_index::weapon_aug || get_item_definition_index() == item_definition_index::weapon_m4a1 ||
				get_item_definition_index() == item_definition_index::weapon_m4a1_silencer || get_item_definition_index() == item_definition_index::weapon_famas ||
				get_item_definition_index() == item_definition_index::weapon_galilar || get_item_definition_index() == item_definition_index::weapon_sg556;

			const bool is_mg = get_item_definition_index() == item_definition_index::weapon_m249 || get_item_definition_index() == item_definition_index::weapon_negev;
		...
		inline bool is_shootable_weapon()
		{
			...
			return !is_grenade() && !is_knife() && def_index != item_definition_index::weapon_c4 && def_index != item_definition_index::weapon_healthshot;
		}
	};
}
