...
namespace sdk
{
	...
	{
		VIRTUAL(1, process_movement_int(cs_player_t* const player, move_data* const data), void(__thiscall*)(void*, cs_player_t*, move_data*))(player, data)
	public:
		inline static auto is_processing = false;

		VIRTUAL(3, start_track_prediction_errors(cs_player_t* const player), void(__thiscall*)(void*, cs_player_t*))(player)
		VIRTUAL(4, finish_track_prediction_errors(cs_player_t* const player), void(__thiscall*)(void*, cs_player_t*))(player)
