...
namespace sdk
{
	...
	public:
		...
		__forceinline bool operator==(const vec3 & other) const
		{
		...
		{
			return sqrt_ps(x * x + y * y + z * z);
		}

		__forceinline float length2d() const
		{
			return sqrt_ps(x * x + y * y);
		}

		__forceinline float length2d_sqr() const
		{
			return x * x + y * y;
		}
	...
	public:
		...
		__forceinline vec3_aligned(const vec3& o) { x = o.x; y = o.y; z = o.z; }
